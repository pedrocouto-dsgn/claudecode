  ...
  return (
    <section className="bg-[#131313] w-full py-20 md:py-32 px-8 md:px-12">
      <div className="max-w-[1920px] mx-auto">
        {/* Title */}
        <h2 className="font-headline text-[50px] font-light tracking-tight text-neutral-400 leading-[1] mb-20 md:mb-28">
          Let&apos;s talk
        </h2>
          ...
          <div className="flex flex-col gap-16">
            ...
            <div className="flex gap-8 md:gap-16">
              ...
              <div className="flex flex-col gap-2">
                <a
                  ...
                  className="font-headline text-[30px] text-white font-light hover:text-neutral-300 transition-colors"
                >
                  +351 21 123 4567
                </a>
                <a
            ...
            <div className="flex gap-8 md:gap-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                  <h4 className="font-headline text-[30px] text-white font-light mb-4">
                    Lisboa
                  </h4>
