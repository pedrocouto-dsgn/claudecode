      ...
      <div className="relative z-10 w-full editorial-grid gap-4">
        <div className="col-span-12 md:col-span-8">
          <h1 className="font-headline text-[50px] leading-[0.9] font-black tracking-tighter uppercase text-white mb-0">
            Um estúdio onde a tua ideia<br />ganha forma com som,<br />imagem e presença.
          </h1>
        </div>

        <div className="col-span-12 md:col-span-8">
          <p className="text-neutral-300 max-w-3xl text-[18px] leading-relaxed mt-6">
            Grava, produz e transmite com qualidade profissional num ambiente pensado ao detalhe,<br />do áudio à imagem, do controlo à experiência.
          </p>
        </div>
      </div>
    </section>
